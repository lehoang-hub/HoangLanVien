...
export default function GalleryPage() {
  ...
  // 🟢 THÊM BIẾN isVideo ĐỂ PHÂN BIỆT RÕ RÀNG
  ...
  return (
    <div className="bg-gray-50 min-h-screen pb-20">
      ...
      <div className="bg-green-800 text-white py-12 text-center">
        <h1 className="text-3xl font-bold mb-2">Thư viện Khoảnh khắc</h1>
        <p className="text-green-100 text-sm">Hình ảnh và video thực tế tại Hoàng Hân FarmStay</p>
      </div>

      <div className="max-w-7xl mx-auto px-4 mt-10 grid grid-cols-2 md:grid-cols-4 gap-6">
        {items.map(item => (
